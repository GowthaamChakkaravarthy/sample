package com.rajeshdeveloper.ajhandbook.libs;
...
public class RRManager extends AsyncTask<JSONObject, Void, JSONObject> {
    private ProgressDialog progressDialog;
    private JSONParser jsonParser;
    private String URL,REQUEST_METHOD;
    private JSONObject params;
    private Context context;
    private String LOADING_MSG = "Please wait... Process is going on";
    ...
    protected JSONObject doInBackground(JSONObject... jsonObjects) {
        try {
            JSONObject jsonObject = jsonParser.makeHttpRequest(this.URL,this.REQUEST_METHOD,this.params);
            return jsonObject;
